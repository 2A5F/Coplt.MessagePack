...
public readonly record struct IDictionaryConverter<TKey, TValue, TKeyConverter, TValueConverter>
    : IMessagePackConverter<IDictionary<TKey, TValue>>
    where TKey : notnull
    where TKeyConverter : IMessagePackConverter<TKey>
    where TValueConverter : IMessagePackConverter<TValue>
{
    public static void Write<TTarget>(ref MessagePackWriter<TTarget> writer, IDictionary<TKey, TValue> value, MessagePackSerializerOptions options)
    ...
    public static IDictionary<TKey, TValue> Read<TSource>(ref MessagePackReader<TSource> reader, MessagePackSerializerOptions options)
    ...
    public static async ValueTask WriteAsync<TTarget>(AsyncMessagePackWriter<TTarget> writer, IDictionary<TKey, TValue> value,
    ...
    public static async ValueTask<IDictionary<TKey, TValue>> ReadAsync<TSource>(AsyncMessagePackReader<TSource> reader, MessagePackSerializerOptions options)
