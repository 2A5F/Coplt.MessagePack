...
public interface IAsyncReadSource
{
    ...
    public ValueTask<ReadOnlyMemory<byte>> PeakAsync(int length);
    public ValueTask<T0> PeakAsync<T0>() where T0 : unmanaged;
    public ValueTask<(T0, T1)> PeakAsync<T0, T1>() where T0 : unmanaged where T1 : unmanaged;
    public ValueTask<(T0, T1, T2)> PeakAsync<T0, T1, T2>() where T0 : unmanaged where T1 : unmanaged where T2 : unmanaged;
}
